...
//****************************************************************************************************************
//Soumet le formulaire de cr�ation de tache
    ...
    var request = new Ajax.Request(
        url,
        {
            ...
            onSuccess: function onSuccess(transport)
            {
                ...
                //rafraichit la liste si c une cr�ation & vide le form
                if (taskId == '')
                {
...
//****************************************************************************************************************
//Affiche la tache pour l'�diter (ou juste la consulter)
function editTask(taskId, gridGuid)
{
    //D�fini la position de la ligne dans le table
    var position = findRowPosition(taskId, gridGuid);
    ...
    else
    {
        ...
        //Charge le formulaire pour l'�dition de la tache
