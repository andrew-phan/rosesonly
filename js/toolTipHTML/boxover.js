...
function defHdrStyle() {
	...
	dvHdr.style.border='1px solid #C0C0C0'; //#A5CFE9
	dvHdr.style.padding='3';
	dvHdr.style.fontSize='9pt';
	dvHdr.style.color='#FFFFFF'; //#4B7A98
	dvHdr.style.background='#0A75C3'; //#C8E0F9
	dvHdr.style.filter='alpha(opacity=95)'; // IE
	dvHdr.style.opacity='0'; // FF
}

function defBdyStyle() {
	dvBdy.style.border='1px solid #C0C0C0'; //#A5CFE9
