 ...
 */
class Ant_Catalog_Block_Layer_View extends Mage_Core_Block_Template
{
    /**
     * State block name
     *
    ...
    protected function _getFilterableAttributes()
    {
        ...
        if (is_null($attributes)) {
            $attributes = $this->getLayer1()->getFilterableAttributes();
    ...
    {
        return $this->canShowOptions() || count($this->getLayer1()->getState()->getFilters());
    }
    ...
    {
        $filters = $this->getLayer1()->getState()->getFilters();
        if (!is_array($filters)) {
            $filters = array();
        }
        return $filters;
    }
    public function getClearUrl1()
    {
