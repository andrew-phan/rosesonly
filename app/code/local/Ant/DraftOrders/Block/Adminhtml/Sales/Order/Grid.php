<?php
class Ant_DraftOrders_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection() {
        ...
        if($isShowCompleteTask === "true")
        {
            $collection = Mage::getResourceModel('sales/order_grid_collection')
                ...
                ->addAttributeToFilter('main_table.is_draft',array('eq'=>'1'))
