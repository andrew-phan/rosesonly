 ...
 * @author Quy Cao
 */
class Ant_Imageimport_Model_Catalog_Convert_Adapter_Product extends Mage_Catalog_Model_Convert_Adapter_Product {
    ...
    public function saveRow(array $importData) {
        ...
        $addedFilesCorrespondence = $mediaGalleryBackendModel->addImagesWithDifferentMediaAttributes(
                $product, $arrayToMassAdd, Mage::getBaseDir('media') . DS . 'import', false, $_exclude
        );
        ...
        $addedFilesCorrespondence .= $mediaGalleryBackendModel->addImagesWithDifferentMediaAttributes(
                $product, $arrayToMassAdd2, Mage::getBaseDir('media') . DS . 'import', false, false
        );
        /**
         * End new code
         */
