 ...
 */
class Ant_Adminhtml_Block_Promo_Catalog_Edit_Tab_Main
...
//        $object = Mage::getModel('catalogrule/rule')->load($this->getRequest()->getParam('id'));
//        $imgPath = Mage::getBaseUrl('media') . "Promotions/images/thumb/" . $object['promotionimage'];
//        
//        Mage::log('Image Path: '.$imgPath);
...
//        $fieldset->addField('promotionimage', 'file', array(
//            'label' => Mage::helper('catalogrule')->__('Promotion Image'),
//            'required' => false,
//            'name' => 'promotionimage',
//        ));
//
...
//        }
        ...
        $fieldset->addField('qty_limited', 'text', array(
            'name' => 'qty_limited',
            'label' => Mage::helper('catalogrule')->__('Qty Limited'),
            'title' => Mage::helper('catalogrule')->__('Qty Limited'),
            'required' => false,
        ));
        
        $fieldset->addField('min_monetary', 'text', array(
            'name' => 'min_monetary',
            'label' => Mage::helper('catalogrule')->__('Min Monetary'),
            'title' => Mage::helper('catalogrule')->__('Min Monetary'),
            'required' => false,
        ));
