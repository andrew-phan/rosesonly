 ...
 */
class Ant_Adminhtml_Block_Promo_Quote_Edit_Tab_Main
...
//        $object = Mage::getModel('salesrule/rule')->load($this->getRequest()->getParam('id'));
...
//        }
        ...
        $fieldset->addField('qty_limited', 'text', array(
            'name' => 'qty_limited',
            'label' => Mage::helper('salesrule')->__('Qty Limited'),
            'title' => Mage::helper('salesrule')->__('Qty Limited'),
            'required' => false,
        ));
        
        $fieldset->addField('min_monetary', 'text', array(
            'name' => 'min_monetary',
            'label' => Mage::helper('salesrule')->__('Min Monetary'),
            'title' => Mage::helper('salesrule')->__('Min Monetary'),
            'required' => false,
        ));
