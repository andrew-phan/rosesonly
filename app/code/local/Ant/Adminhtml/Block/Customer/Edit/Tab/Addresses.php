...
class Ant_Adminhtml_Block_Customer_Edit_Tab_Addresses extends Mage_Adminhtml_Block_Customer_Edit_Tab_Addresses
{
    public function initForm()
    {
        ...
        // Phuoc's code
        $telephoneElement = $form->getElement('telephone');
        $telephoneElement->setRequired(true);
        
        $addressElement = $form->getElement('street');
        $addressElement->setRequired(true);
        
        $taxElement = $form->getElement('vat_id');
        $fieldset->removeField($taxElement->getId());
        
        $firstnameElement = $form->getElement('firstname');
        $firstnameElement->setRequired(true);
        
        $lastnameElement = $form->getElement('lastname');
        $lastnameElement->setRequired(false);
