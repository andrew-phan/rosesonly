...
class Ant_Adminhtml_Block_Customer_Edit_Tab_Account extends Mage_Adminhtml_Block_Customer_Edit_Tab_Account {
    public function initForm()
    {
        ...
        if ($customer->getId()) {
            ...
            $form->getElement('website_id')->setAfterElementHtml(
                ...
                . "
                document.getElementById('_accountwebsite_id').selectedIndex = 2;
        ...
        $form->getElement('website_id')->setSelectedIndex(2);
...
//        }
        ...
        if ($customer->getId()) {
            ...
            $newFieldset = $form->addFieldset(
                'password_fieldset',
                array('legend'=>Mage::helper('customer')->__('Password Managementt'))
            );
            $field = $newFieldset->addField('password', 'text',
                array(
                    'label' => Mage::helper('customer')->__('Default Password'),
        ...
        $birthdayElement = $form->getElement('dob');
        $birthdayElement->setNote('Date format: mm/dd/yyyyyy');
