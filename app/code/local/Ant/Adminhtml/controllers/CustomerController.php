...
class Ant_Adminhtml_CustomerController extends Mage_Adminhtml_CustomerController
{
    /**
    ...
    public function saveAction()
    {
        ...
        if ($data) {
            ...
            $redirectCreate = $this->getRequest()->getParam('create', false);
            ...
            try {
                ...
                // Phuoc's code
                if ($redirectCreate) {
                    $this->_redirect('adminhtml/sales_order_create/start', array('customer_id' => $customer->getId()));
                    return;
                }
                // end code
