...
class Ant_Adminhtml_Sales_Order_RedeliveryController extends Mage_Adminhtml_Sales_Order_EditController {
    
    public function startAction() {
        $orderId = $this->getRequest()->getParam('order_id');
        Mage::getModel('core/session')->setData('re_order_id',$orderId);
        parent::startAction();
    }
    ...
    public function saveAction()
    {
        try {
            ...
            $order_id = Mage::getModel('core/session')->getData('re_order_id');
