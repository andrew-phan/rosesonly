...
class Infortis_Ultimo_Helper_Labels extends Mage_Core_Helper_Abstract
{
    ...
    public function getSaleOfShoppingCart($product)
    {
        $html = '';
        ...
        if ($isNew == true)
        {
            //$html .= '<span class="sticker-wrapper top-left-shopping-cart"><span class="sticker-shopping-cart new-cart">' . $this->__('New') . '</span></span>';
        }

        if ($isSale == true)
        {
            $html .= '<span class="sticker-wrapper top-right-shopping-cart"><span class="sticker-shopping-cart sale-cart">' . $this->__('Sale') . '</span></span>';
        }
