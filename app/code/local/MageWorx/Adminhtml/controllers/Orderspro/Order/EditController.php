...
class MageWorx_Adminhtml_Orderspro_Order_EditController extends Mage_Adminhtml_Sales_Order_EditController {
    public function saveAction() {
        try {
            ...
            //$del_time = $this->getRequest()->getPost('mw_deliverydate_time');
...
//        Mage::getSingleton('adminhtml/session')->addSuccess($order->getStatus());
        ...
        if ($paymentData && isset($paymentData['method']) && ($paymentData['method']=='authorizenet' || $paymentData['method']=='paypal_direct') && !isset($paymentData['cc_number'])) {
