...
{   
    ...
    {                
        $options = array(            
            ...
            array('value'=>'base_internal_credit', 'label'=> Mage::helper('orderspro')->__('Internal Credit (Base)')), // 17
            array('value'=>'internal_credit', 'label'=> Mage::helper('orderspro')->__('Internal Credit (Purchased)')), // 18
        ...
        if (!Mage::getConfig()->getModuleConfig('MageWorx_CustomerCredit')->is('active', true)) {
            unset($options[17]); // Internal Credit (Base)
            unset($options[18]); // Internal Credit (Purchased)
        }                
