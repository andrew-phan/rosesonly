 ...
 */
Class Magazento_Pdfinvoice_Model_Shipment extends Mage_Sales_Model_Order_Pdf_Abstract // AuIt_Pdf_Model_Pdf_Abstract
{
    protected $_streams;
    protected $_data;
    protected $_HTML;
    ...
    protected function drawShipments($invoices)
    {
        foreach ($invoices as $invoice) {
            ...
            $this->_data = Mage::getModel('pdfinvoice/pdf')->processPDF($invoice,$order,$block,'shipment');
