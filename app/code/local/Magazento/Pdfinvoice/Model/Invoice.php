 ...
 */
Class Magazento_Pdfinvoice_Model_Invoice extends Mage_Sales_Model_Order_Pdf_Abstract // AuIt_Pdf_Model_Pdf_Abstract
{
    ...
    protected function drawInvoices($invoices)
    {
        foreach ($invoices as $invoice) {
            ...
            $this->_data = Mage::getModel('pdfinvoice/pdf')->processPDF($invoice,$order,$block,'invoice');
