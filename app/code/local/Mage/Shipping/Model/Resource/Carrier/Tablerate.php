...
class Mage_Shipping_Model_Resource_Carrier_Tablerate extends Mage_Core_Model_Resource_Db_Abstract {
    ...
    public function getRate(Mage_Shipping_Model_Rate_Request $request) {
        ...
        $orWhere = '(' . implode(') OR (', array(
                    "dest_region_id = :region_id AND dest_zip = :postcode",
                    "dest_region_id = :region_id AND dest_zip = ''",
                    "dest_region_id = :region_id AND dest_zip = '*'",
                    "dest_region_id = 0 AND dest_zip = :postcode",
                    "dest_region_id = 0 AND dest_zip = ''",
                    "dest_region_id = 0 AND dest_zip = '*'",
                    "dest_region_id = '*' AND dest_zip = :postcode",
                    "dest_region_id = '*' AND dest_zip = ''",
                    "dest_region_id = '*' AND dest_zip = '*'",
                )) . ')';
