...
class Mage_Checkout_Block_Cart_Item_Renderer extends Mage_Core_Block_Template
{
    ...
    public function getProductOptions()
    {
        ...
        return array_merge(
            Mage::helper('catalog/product_configuration')->getCustomOptions($this->getItem()),
            Mage::helper('quotation/bundle_catalog_product_configuration')->getBundleOptionsMini($this->getItem())
            //$this->getBundleOptions($this->getItem())
