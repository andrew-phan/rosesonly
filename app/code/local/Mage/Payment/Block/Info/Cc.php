...
class Mage_Payment_Block_Info_Cc extends Mage_Payment_Block_Info
{
    ...
    public function getCcExpDate()
    {
        ...
        if($this->getInfo()->getCcExpYear()!= NULL)
            $date->setYear($this->getInfo()->getCcExpYear());
        
        if($this->getInfo()->getCcExpMonth()!=NULL)
    ...
    protected function _prepareSpecificInformation($transport = null)
    {
        ...
        if ($this->getInfo()->getCcLast4()) {
            $data[Mage::helper('payment')->__('Credit Card Number')] = sprintf('xxxx-xxxx-xxxx-%s', $this->getInfo()->getCcLast4());
        }
        ...
        $data[Mage::helper('payment')->__('Expiration Date')] = $this->getCcExpDate();
