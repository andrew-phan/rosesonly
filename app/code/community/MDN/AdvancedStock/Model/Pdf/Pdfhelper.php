 ...
 */
abstract class MDN_AdvancedStock_Model_Pdf_Pdfhelper extends Mage_Sales_Model_Order_Pdf_Abstract
{
	 ...
	 */
	 public function widthForStringUsingFontSize($string, $font, $fontSize)
	 {
	 	...
	 	{
	 		die("Erreur dans Mdn pdf helper méthode widthForStringUsingFontSize avec string = ".$string.' - '.$ex->getMessage().' - '.$ex->getTraceAsString());
	 	}
	 }
