...
class MDN_AdvancedStock_Block_Adminhtml_Catalog_Product_Edit_Tab_Inventory extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Inventory {
    ...
    protected function _toHtml() {
        ...
        if (mage::getStoreConfig('advancedstock/general/replace_magento_inventory_tab') == 1) {
            ...
            $parentHtml .= '<p>' . $this->__('This feature is replaced with ERP product view.') . ' : <a href="' . $this->getUrl('AdvancedStock/Products/Edit', array('product_id' => $this->getProduct()->getId())) . '">' . $this->__('Click here to access to ERP view') . '</a></p>';
            $parentHtml .= '<p>&nbsp;</p>';

            $parentHtml .= '                                    <div class="entry-edit-head">
