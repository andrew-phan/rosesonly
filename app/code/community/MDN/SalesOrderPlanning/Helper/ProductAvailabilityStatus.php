...
class MDN_SalesOrderPlanning_Helper_ProductAvailabilityStatus extends Mage_Core_Helper_Abstract {
    ...
    public function RefreshOnlyMissing() {
        ...
        foreach ($missingProductIds as $productId) {
            mage::helper('BackgroundTask')->AddTask('Update missing product availability status for product #' . $productId, 'SalesOrderPlanning/ProductAvailabilityStatus', 'RefreshForOneProduct', $productId, $taskGroup
            );
        }
