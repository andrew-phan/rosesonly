    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
    ...
    {
    	return $this->getUrl('SalesOrderPlanning/Planning/Create', array('order_id' => $this->getOrder()->getId()));
    }
    
    
    public function getResetUrl()
    {
    	return $this->getUrl('SalesOrderPlanning/Planning/reset', array('psop_id' => $this->getPlanning()->getId()));
    }
    
    
    public function getSubmitUrl()
    {
    	return $this->getUrl('SalesOrderPlanning/Planning/Save');
    }
    
    public function getUpdateNowUrl()
    {
    	return $this->getUrl('SalesOrderPlanning/Planning/Update', array('psop_id' => $this->getPlanning()->getId()));
    }
