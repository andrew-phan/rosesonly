...
class MDN_Purchase_Model_Convert_Adapter_SupplyNeeds extends Mage_Dataflow_Model_Convert_Container_Abstract
{
    ...
    public function load()
    {
		...
		$this->_collection = mage::getModel('Purchase/SupplyNeeds')    
			->getCollection()
			->setOrder('sn_id', 'asc');	
