    ...
    public function getValuesHtml()
    {
        ...
        if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_RADIO
            ...
            foreach ($_option->getValues() as $_value) {
                ...
                $selectHtml .= '<li>' . '<input qty="'.$_value->getQuantity().'" type="' . $type . '" class="ant_attribute ' . $class . ' ' . $require
                    . ' product-custom-option"'
                    . ($this->getSkipJsReloadPrice() ? '' : ' onclick="opConfig.reloadPrice();updateQty('.$_value->getQuantity().')"')
