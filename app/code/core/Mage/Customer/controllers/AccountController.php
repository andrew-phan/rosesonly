...
class Mage_Customer_AccountController extends Mage_Core_Controller_Front_Action
{
        ...
        if ($this->getRequest()->isPost()) {
            ...
            try {
                ...
                if (true === $validationResult) {
                    ...
                    /* Add email customer to cheetahmail system */
                    $aid = 2095840058;
                    $sub = 2095847118;
                    $email = (string) $this->getRequest()->getPost('email');
                    $firstname = (string) trim($this->getRequest()->getPost('firstname'));
                    $lastname = (string) trim($this->getRequest()->getPost('lastname'));

                    if ($this->getRequest()->getParam('is_subscribed', false)) {

                        Mage::helper('gentotech_cheetahmail')->_login();
                        Mage::getModel('gentotech_cheetahmail/webservice_subscribers')->Ems_Subscribers_Add($aid, $email, $sub, null, $firstname, $lastname);

                    }
                    /* end add email customer */
    ...
    protected function _welcomeCustomer(Mage_Customer_Model_Customer $customer, $isJustConfirmed = false)
    {
        ...
        $successUrl = Mage::getUrl('checkout/onepage', array('_secure'=>true));
    ...
    public function editPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($this->getRequest()->getParam('is_subscribed', false)) {
                ...
                /* subscribe email account to cheetahmail system */
                $aid = 2095840058;
                $sub = 2095847118;
                ...
                /* Unsubscribe email account to cheetahmail system */
                $aid = 2095840058;
                $unsub = 2095847118;
                $firstname = $customer->getFirstname();
                $lastname = $customer->getLastname();
                ...
                Mage::helper('gentotech_cheetahmail')->_login();
                Mage::getModel('gentotech_cheetahmail/webservice_subscribers')->Ems_Subscribers_Add($aid, $email, null, $unsub, $firstname, $lastname);
                /* end unsubscibe email */
