...
class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
{
    ...
    public function addAction()
    {
        ...
        // Hau added: set session for delivery date and time
        $delivered_date = $params['_deliverydate'];
        $delivered_time = $params['onestepcheckout_time'];
        $session = Mage::getSingleton('core/session');
        $session->setData('_deliverydate',$delivered_date);
        $session->setData('onestepcheckout_time', $delivered_time);
        // end 
