...
Billing.prototype = {
    ...
    newAddress: function(isNew, value){
        if (isNew) {
            this.resetSelectedAddress();
            Element.show('billing-new-address-form');
            $('billing:save_in_address_book').show();
            $('billing:save_in_address_book').next().show();            
        } else {
            //Element.hide('billing-new-address-form');
            if(value != undefined)
                this.updateSelectedAddress(value);
            $('billing:save_in_address_book').hide();
            $('billing:save_in_address_book').next().hide();
        }
        update_review();
        updateTax();
    },
    ...
    updateSelectedAddress: function (value){
        var selectElement = $('billing-address-select')
        if (selectElement) {            
            $('billing:firstname').value=$('firstname-'+value).value;
            $('billing:lastname').value=$('lastname-'+value).value;
            $('billing:company').value=$('company-'+value).value;
            $('billing:street1').value=$('street1-'+value).value;
            $('billing:street2').value=$('street2-'+value).value;
            $('billing:city').value=$('city-'+value).value;
            $('billing:postcode').value=$('postcode-'+value).value;
            $('billing:telephone').value=$('telephone-'+value).value;
...
Shipping.prototype = {
    ...
    newAddress: function(isNew, value){ 
        ...
        if (isNew) {           
            ...
            $('shipping:save_in_address_book').show();
            $('shipping:save_in_address_book').next().show();
            ...
            $('shipping:save_in_address_book').hide();
            $('shipping:save_in_address_book').next().hide();
    ...
    resetSelectedAddress: function(){
        ...
        if (selectElement) {
            ...
            $('shipping:telephone').value='';
            
            $('shipping:firstname').disabled  = false;
            $('shipping:lastname').disabled  = false;
            $('shipping:company').disabled  = false;
            $('shipping:street1').disabled  = false;
            $('shipping:street2').disabled  = false;
            $('shipping:city').disabled  = false;
            $('shipping:postcode').disabled  = false;
            $('shipping:telephone').disabled  = false;
        }
    },
    ...
    updateSelectedAddress: function (value){
        var selectElement = $('shipping-address-select')
        if (selectElement) {             
            $('shipping:firstname').value=$('firstname-'+value).value;            
            $('shipping:lastname').value=$('lastname-'+value).value;
            $('shipping:company').value=$('company-'+value).value;
            $('shipping:street1').value=$('street1-'+value).value;
            $('shipping:street2').value=$('street2-'+value).value;
            $('shipping:city').value=$('city-'+value).value;
            $('shipping:postcode').value=$('postcode-'+value).value;
            $('shipping:telephone').value=$('telephone-'+value).value;
            
            $('shipping:firstname').disabled  = true;
            $('shipping:lastname').disabled  = true;
            $('shipping:company').disabled  = true;
            $('shipping:street1').disabled  = true;
            $('shipping:street2').disabled  = true;
            $('shipping:city').disabled  = true;
            $('shipping:postcode').disabled  = true;
            $('shipping:telephone').disabled  = true;
        }
    },
